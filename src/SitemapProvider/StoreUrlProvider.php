...
namespace Dotit\SyliusAppearancePlugin\SitemapProvider;

use Doctrine\Common\Collections\Collection;
use Dotit\SyliusAppearancePlugin\Entity\Socialmediainterface;
use Dotit\SyliusAppearancePlugin\Entity\storeTranslation;
use Dotit\SyliusAppearancePlugin\Repository\SocialMediaRepositoryInterface;
...
{
    private SocialMediaRepositoryInterface $storeRepository;
    ...
    public function __construct(
        SocialMediaRepositoryInterface $storeRepository,
     ...
     */
    private function getTranslations(Socialmediainterface $store): Collection
    {
    ...
    private function createstoreUrl(Socialmediainterface $store): UrlInterface
    {
        ...
        foreach ($this->getTranslations($store) as $translation) {
            ...
            $location = $this->router->generate('dotit_sylius_appearance_plugin_shop_store_product_index', [
                'slug' => $store->getSlug(),
