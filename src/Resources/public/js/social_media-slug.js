(function ($) {
    ...
    $.fn.extend({
        socialMediaSlugGenerator: function () {
            let timeout;

            $('[name*="dotit_social_media"][name*="[name]"]').on('input', function() {
            ...
            $('.toggle-social-media-slug-modification').on('click', function(e) {
                e.preventDefault();
